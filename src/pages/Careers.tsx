    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#7C3AED]/30 font-sans cursor-default">
      ...
      >
        ...
        <div className="max-w-[1200px] w-full mx-auto relative z-10 flex flex-col items-center">
          ...
          >
            <div className="relative rounded-[2.5rem] bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A] border border-white/10 p-12 md:p-16 overflow-hidden backdrop-blur-2xl transition-all duration-500 hover:border-purple-500/50 hover:shadow-[0_0_80px_-15px_rgba(124,58,237,0.4)] group">
              ...
              {/* Glowing orbs */}
              <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-purple-600/20 blur-[120px] rounded-full pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-500/15 blur-[100px] rounded-full pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              ...
              <div className="flex flex-col md:flex-row gap-10 items-start relative z-10">
                ...
                <motion.div 
                  ...
                  className="mt-2 w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-white/20 flex items-center justify-center shrink-0 shadow-lg shadow-purple-500/20 group-hover:shadow-purple-500/40 transition-shadow"
                >
                ...
                <div className="flex-1 space-y-7">
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    {[
                      ...
                      <motion.span 
                        ...
                        className="bg-white/5 border border-white/10 text-white/80 px-6 py-2.5 rounded-full text-xs font-semibold tracking-wide transition-all hover:bg-white/10 hover:border-purple-500/30 cursor-default flex items-center gap-2 shadow-lg"
                      >
                        {tag.icon}
                        {tag.label}
                      </motion.span>
                  ...
                  {/* CTA Arrow */}
                  <motion.div 
                    className="flex items-center gap-2 text-purple-400 font-semibold pt-4"
                    animate={{ x: [0, 10, 0] }}
      ...
      <section className="bg-white py-32 px-6 md:px-12 text-black relative overflow-hidden">
        ...
        <div className="max-w-[1240px] mx-auto relative z-10">
          <motion.div 
            ...
            className="mb-16"
          >
            <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-green-600/30 text-green-700 bg-gradient-to-r from-green-50 to-emerald-50 text-xs font-bold uppercase tracking-widest shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            ...
            <div className="max-w-xl">
              ...
              {/* Animated Text Lines */}
              <div className="text-xl md:text-[1.7rem] leading-[1.6] font-medium space-y-2">
                {[
            ...
            <div className="space-y-6">
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-white to-gray-50 p-12 rounded-[2.5rem] border border-gray-100 shadow-xl cursor-pointer group transition-all relative overflow-hidden"
              >
                {/* Animated gradient overlay */}
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-br from-purple-500/0 to-blue-500/0 group-hover:from-purple-500/5 group-hover:to-blue-500/5 transition-all duration-700"
                />
                ...
                <div className="relative z-10">
                  <div className="flex gap-4 mb-10 items-center">
                    {[
                      ...
                      <motion.div
                        ...
                        className="w-16 h-16 rounded-full bg-white border border-gray-200 flex items-center justify-center shadow-lg shadow-gray-200/50 overflow-hidden"
                      >
                  ...
                  <motion.h3 
                    className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent"
                    whileHover={{ scale: 1.05 }}
                  >
                    2000+
                  </motion.h3>
                  <p className="text-gray-600 text-xl font-semibold">5-Star Verified Reviews</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10">
                  <motion.div 
                    className="mb-8 w-16 h-10 relative"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.8 }}
                  >
                    <div className="absolute inset-0 border-[3px] border-purple-600 rounded-full skew-x-12" />
                    <div className="absolute inset-0 border-[3px] border-blue-500 rounded-full -skew-x-12" />
                  </motion.div>

                  <h3 className="text-5xl font-bold mb-3 text-gray-900">20+</h3>
                  <h4 className="text-3xl font-bold mb-5 text-gray-900">Clients</h4>
