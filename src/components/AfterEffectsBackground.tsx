...
const AfterEffectsBackground = () => {
  return (
    <div className="font-system relative w-[95%] max-w-[1400px] mx-auto h-[85vh] my-12 bg-[#1e1e1e] overflow-hidden rounded-[20px] shadow-2xl border-[12px] border-[#111] transform hover:scale-[1.01] transition-transform duration-700">
      {/* Top Menu Bar */}
