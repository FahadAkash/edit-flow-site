        ...
        <div className="max-w-5xl mx-auto relative overflow-hidden">
              ...
              <div className="mb-6 flex justify-center">
                <div className={`relative ${
                    ...
                    <>
                      ...
                      <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                        <motion.div 
                          ...
                          whileTap={{ scale: 0.9 }}
                          className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-2xl cursor-pointer"
                        >
                          <Play className="w-12 h-12 text-[#d72638] ml-2" />
                        </motion.div>
                      </div>
                    </>
                  )}
                  ...
                  <div className="absolute bottom-6 right-6">
                    <div className="bg-white text-[#d72638] px-4 py-2 rounded-lg shadow-lg">
          ...
          <div className="flex justify-center items-center gap-4 mt-8">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={prevCase}
              className="rounded-full w-12 h-12 bg-white/10 hover:bg-white text-white hover:text-[#d72638] transition-all flex items-center justify-center cursor-pointer border border-white/20"
